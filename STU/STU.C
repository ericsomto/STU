...
typedef struct// to call in program
{
    ...
    char matricNo[MAX_MATRIC_NO];// declare the charecter data type
...
void headMessage(const char *message)
{
    ...
    printf("\t\t\t###########################################################################");
    printf("\n\t\t\t############                                                   ############");
    printf("\n\t\t\t############    Enugu State University Result System           ############");
    printf("\n\t\t\t############                                                   ############");
    printf("\n\t\t\t###########################################################################");
    printf("\n\t\t\t---------------------------------------------------------------------------\n");
...
void addStudentInDataBase()
{
    ...
    do
    {
        printf("\n\t\t\tMatric No  = ");
        fflush(stdin);
        fgets(addStudentInfoInDataBase.matricNo,MAX_MATRIC_NO,stdin);
        status = isNameValid(addStudentInfoInDataBase.matricNo);
        if (!status)
        {
    ...
    do
    {
        printf("\n\t\t\tStudent Address  = ");
        fflush(stdin);
	fgets(addStudentInfoInDataBase.studentAddr,MAX_MATRIC_NO,stdin);
...
void searchStudent()
{
    ...
    if(found)
    {
        ...
        printf("\t\t\tMatric No = %s",addStudentInfoInDataBase.matricNo);
...
void init()
{
    FILE *fp = NULL;
    int status = 0;
    const char defaultUsername[] ="somtochukwu\n";
    const char defaultPassword[] ="somtochukwu\n";
    sFileHeader fileHeaderInfo = {0};
